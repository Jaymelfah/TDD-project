...
**TDD Project** is a project where we implemented a class with some methods with test-driven development (TDD). We wrote tests first and then the code
...
```sh
  cd enumerable
  git clone https://github.com/Jaymelfah/TDD-project.git
```
